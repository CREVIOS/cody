...
export default function EntryPage({ onNewProject }: EntryPageProps) {
  ...
  const menuHoverClass = theme === "dark"
    ? "hover:bg-[#3A3A3E]"
    : "hover:bg-gray-100";
  ...
  return (
    <div className={`min-h-screen flex flex-col ${backgroundClass}`}>
        ...
        {menuOpen && (
          ...
          >
            <ul className="text-sm relative z-10">
              ...
              <li className={`px-4 py-3 ${theme === "dark" ? "hover:bg-red-900/30 text-red-400" : "hover:bg-red-100 text-red-600"} cursor-pointer`}>
                Log out
              </li>
            </ul>
          </div>
      ...
      <div className="flex flex-1 px-8 py-8 gap-8">
            ...
            style={{
              textShadow:
                theme === "dark"
                  ...
                  : "0 0 15px rgba(79, 70, 229, 0.6), 0 0 30px rgba(79, 70, 229, 0.3)"
            }}
          >
            Welcome back, {name}
          </h1>
            ...
            style={{
              textShadow:
                theme === "dark"
                  ...
                  : "0 0 10px rgba(79, 70, 229, 0.6), 0 0 20px rgba(79, 70, 229, 0.3)"
            }}
          >
            Your Projects
          </h2>
